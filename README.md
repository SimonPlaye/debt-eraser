# Simulating the Erasure of France's Public Debt
...
The simulations pages allow users to input different values for the tax rates and spending reduction, and see how these changes would affect the public debt and deficit of France over time.
